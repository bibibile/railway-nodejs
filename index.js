...
const SUB_PATH = process.env.SUB_PATH || '65661229-b893-40c1-84dd-51e7ce204913';       // 订阅路径
const PORT = process.env.SERVER_PORT || process.env.PORT || 3000;        // http服务订阅端口
const UUID = process.env.UUID || '65661229-b893-40c1-84dd-51e7ce204913'; // 使用哪吒v1,在不同的平台运行需修改UUID,否则会覆盖
const NEZHA_SERVER = process.env.NEZHA_SERVER || 'nz.geniubi.pp.ua:443';        // 哪吒v1填写形式: nz.abc.com:8008  哪吒v0填写形式：nz.abc.com
const NEZHA_PORT = process.env.NEZHA_PORT || '';            // 使用哪吒v1请留空，哪吒v0需填写
const NEZHA_KEY = process.env.NEZHA_KEY || 'lK9cDOcwCWAX9l93lcGB8Nf6vFPhSisk';              // 哪吒v1的NZ_CLIENT_SECRET或哪吒v0的agent密钥
const ARGO_DOMAIN = process.env.ARGO_DOMAIN || 'mags.aive.us.ci';          // 固定隧道域名,留空即启用临时隧道
const ARGO_AUTH = process.env.ARGO_AUTH || 'eyJhIjoiZTA3MGQ0NmE4MjM3NmRiMjcwMTBhOTAyMjUxYzU5ZGEiLCJ0IjoiNzEyNjQwNGEtYjExNi00M2FjLWI5ZjAtNjhjZTNmMjdhYTUyIiwicyI6Ik1UYzJaV05qT1dJdE16UXlNQzAwWVRnd0xXRXhPV0l0TVRCaFl6SXdZVFU1TVRaaiJ9';              // 固定隧道密钥json或token,留空即启用临时隧道,json获取地址：https://json.zone.id
